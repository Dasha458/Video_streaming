...
class PlaylistService:
    ...
    async def list_user_playlists(self, user_id: UUID) -> Tuple[List[PlaylistResponse], int]:
    ...
    async def create(self, user_id: UUID, name: str, description: str | None = None) -> PlaylistResponse:
    ...
    async def get_detail(self, user_id: UUID, playlist_id: UUID) -> PlaylistDetailResponse:
        playlist = await self._get_owned(user_id, playlist_id)
    ...
    async def remove_video(self, user_id: UUID, playlist_id: UUID, video_id: UUID) -> None:
        playlist = await self._get_owned(user_id, playlist_id)
