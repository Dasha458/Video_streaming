...
### 7. Наповнення демо-даними (опціонально)

Довідники (статуси відео, рівні приватності, типи реакцій, категорії, ролі) створює міграція
`d3e4f5a6b7c8` на кроці 5 — без них застосунок не працює, тому вони не «тестові дані».
Сідер нижче додає **демо-контент**: користувачів, канали, відео з аналітикою.
